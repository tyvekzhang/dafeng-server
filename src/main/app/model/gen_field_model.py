...
class GenFieldBase(SQLModel):
    ...
    detailable: Optional[int] = Field(default=0, sa_column=Column(SmallInteger, comment="详情字段(0否,1是)"))
    modifiable: Optional[int] = Field(default=0, sa_column=Column(SmallInteger, comment="修改字段(0否,1是)"))
    batch_modifiable: Optional[int] = Field(default=0, sa_column=Column(SmallInteger, comment="批量修改(0否,1是)"))
